...
<div class="navbar">
  <div id="myDIV">
  <button class="button" onclick="window.location.href='user_homepage.php'"><i class="fa fa-fw fa-home"></i> Home</button>
    <button class="button" onclick="window.location.href='user_update_page.php'"><i class="fa fa-fw fa-pencil"></i> Search</button>
    <button class="button" onclick="window.location.href='user_report.php'"><i class="fa fa-fw fa-file"></i> View Reports</button>
